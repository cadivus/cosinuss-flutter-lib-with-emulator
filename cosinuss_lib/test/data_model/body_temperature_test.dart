...
void main() {
  ...
  test('From JSON', () {
    Map<String, dynamic> json = {'value': 37.95};
    BodyTemperature parsedBodyTemperature = BodyTemperature.fromJson(json);

    expect(37.95, parsedBodyTemperature.value);
  });

  test('To JSON', () {
    BodyTemperature bodyTemperature = BodyTemperature(value: 23.45);
    Map<String, dynamic> json = bodyTemperature.toJson();

    expect(23.45, json['value']);
  });
}
