...
void main() {
  ...
  test('From JSON', () {
    Map<String, dynamic> json = {'value': 112};
    HeartRate parsedHeartRate = HeartRate.fromJson(json);

    expect(112, parsedHeartRate.value);
  });

  test('To JSON', () {
    HeartRate heartRate = HeartRate(value: 113);
    Map<String, dynamic> json = heartRate.toJson();

    expect(113, json['value']);
  });
}
